...
var AuthenticationService = /** @class */ (function () {
    ...
    AuthenticationService.prototype.login = function (imei, password) {
        return this.http.post(_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].apiUrl + "/users/authenticate", { imei: imei, password: password })
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (user) {
            // login successful if there's a jwt token in the response
            if (user && user.token) {
                // store user details and jwt token in local storage to keep user logged in between page refreshes
                localStorage.setItem('currentUser', JSON.stringify(__assign({}, user, { imei: imei })));
            }
            return user;
        }));
    };
...
var config = { url: 'http://' + window.location.hostname + ':4000', options: { query: "token=" + JSON.parse(user).token + '&iemi=' + JSON.parse(user).imei } };
...
/*!****************************************!*\
  !*** ./src/app/home/home.component.ts ***!
  \****************************************/
/*! exports provided: Message, HomeComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "Message", function() { return _home_component__WEBPACK_IMPORTED_MODULE_0__["Message"]; });
...
var LoginComponent = /** @class */ (function () {
    ...
    LoginComponent.prototype.onSubmit = function () {
        ...
        this.loading = true;
        this.authenticationService.login(this.f.imei.value, this.f.password.value)
